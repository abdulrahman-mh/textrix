...
import type { Range, SuggestionKeyDownProps } from '../types';
import { findSuggestionMatch as defaultFindSuggestionMatch } from '../helpers/findSuggestionMatch';
...
export interface SuggestionOptions<I = any, TSelected = any> {
   ...
   * @param props.view The editor view.
   * @param props.range The range of the suggestion.
   * @param props.props The props of the selected suggestion.
   * @returns void
   * @example ({ view, range, props }) => { props.command(props.props) }
   */
  command?: (props: { editor: Editor; view: EditorView; range: Range; props: TSelected }) => void;
  ...
  const plugin: Plugin<any> = new Plugin({
          ...
          props = {
            ...
            clientRect: decorationNode
              ? () => {
                  ...
                  const { decorationId } = this.key?.getState(view.state);
    ...
    state: {
      ...
      apply(transaction, prev, _oldState, state) {
        ...
        if (editable && (empty || view.composing)) {
